async def generate_quote_image(user: discord.Member, quote_text: str) -> bytes:
    ...
    try:
        ...
        # Resize avatar to 300x300 (doubled from 150)
        ...
        username_font = ImageFont.load_default(size=32)
        ...
        line_height = 50  # Increased from 30
        text_height = len(lines) * line_height
        min_bubble_height = text_height + 150  # More padding
        ...
        # Create final canvas
        canvas_width = 350 + bubble.width  # More space for larger avatar
        canvas_height = max(350, bubble.height)  # At least avatar height
        canvas = Image.new('RGBA', (canvas_width, canvas_height), (0, 0, 0, 0))
        
        # Paste avatar on left
        avatar_y = (canvas_height - 300) // 2
        ...
        for i, line in enumerate(lines):
            ...
            text_x = 325 + (bubble.width - text_width) // 2
